...
\begin{diagram}[column sep=10pt]
\ldots\rar\&{\textstyle\prod_\alpha G_\alpha}\rar{d}\ar[dd,dash,"\iso"]\&{\textstyle\prod_\beta G_\beta}\ar[dd,dash,"\iso"]\rar\ar[rd]\&\ldots\\
G_\alpha\ar[ru]\dar[dash]{\iso}\&\&\&G_\beta\dar[dash]{\iso}\\
h^n(D^n_\alpha/\partial D^n_\alpha)\rar\&h^n(X^n/X^{n-1})\rar{d}\&h^{n+1}(X^{n+1}/X^n)\rar\&h^{n+1}(D^{n+1}_\beta/\partial D^{n+1}_\beta)\dar[dash]{\iso}\\
...
\begin{diagram}
{\textstyle\prod_\alpha G_\alpha}\rar{d}\dar\&{\textstyle\prod_\beta G_\beta}\rar\&G_\beta\iso h^n(\partial D^{n+1}_\beta)\\
