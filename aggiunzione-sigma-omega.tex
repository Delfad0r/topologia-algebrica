...
\]
\only<2>{\tikz[overlay,remember picture] \draw ++(mark.south) +(1,-1.8) node[anchor=west,overlay text] {$Y^{X\times[0,1]}\longleftrightarrow \big(Y^{[0,1]}\big)^X$} edge[overlay arrow,shorten >=7pt,bend left] +(0,0);}
